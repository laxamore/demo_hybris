...
import com.demo.facades.customer.impl.DemoCustomerFacade;
...
public class RegisterPageController extends AbstractRegisterPageController {
    ...
    @Resource(name = "demoRegistrationValidator")
    private Validator registrationValidator;

    @Resource
    private DemoCustomerFacade demoCustomerFacade;
    ...
    public String doRegister(final Model model) throws CMSItemNotFoundException {
        model.addAttribute(new DemoRegisterForm());
        return getDefaultRegistrationPage(model);
    }

    @RequestMapping(value = "/newcustomer", method = RequestMethod.POST)
    public String doRegister(final DemoRegisterForm form, final BindingResult bindingResult, final Model model,
    ...
    protected String processRegisterUserRequest(final String referer, final DemoRegisterForm form, final BindingResult bindingResult,
