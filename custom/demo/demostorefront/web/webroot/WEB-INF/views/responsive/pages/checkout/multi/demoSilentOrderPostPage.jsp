...
<template:demoPage pageTitle="${pageTitle}" hideHeaderLinks="true">
    <div class="demo-main">
        <div class="row demo-content" style="padding: 4rem 0;">
            <div class="col-sm-6">
                                ...
                                <div class="checkout-indent">
                                    ...
                                    <ycommerce:testId code="paymentDetailsForm">
                                        ...
                                        <form:form id="silentOrderPostForm" name="silentOrderPostForm"
                                                   modelAttribute="sopPaymentDetailsForm" action="${paymentFormUrl}"
                                                   method="POST">
                                            ...
                                            <address:billAddressFormSelector
                                                    supportedCountries="${supportedBillingCountries}"
                                                    regions="${regions}"
                                                    tabindex="12"/>
                            ...
                            <div id="savedpayments">
                                ...
                                <div id="savedpaymentsbody">
                                    <spring:url var="choosePaymentMethodUrl"
                                                value="{contextPath}/checkout/multi/payment-method/choose"
                                                htmlEscape="false">
