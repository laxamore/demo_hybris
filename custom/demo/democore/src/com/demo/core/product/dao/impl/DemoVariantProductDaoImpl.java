...
public class DemoVariantProductDaoImpl implements DemoVariantProductDao {
    ...
    private static final String QUERY_DEMO_VARIANT_PRODUCT = "SELECT {pk} FROM {DemoVariantProduct}";
    ...
    public DemoVariantProductModel getDemoVariantProductById(String name) {
        ...
        final FlexibleSearchQuery flexibleSearchForProductQuery = new FlexibleSearchQuery(QUERY_DEMO_VARIANT_PRODUCT);
    ...
    public List<DemoVariantProductModel> getDemoVariantProduct() {
        ...
        final FlexibleSearchQuery flexibleSearchForFindProductQuery = new FlexibleSearchQuery(QUERY_DEMO_VARIANT_PRODUCT);
